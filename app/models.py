...
class Config(db.Model):
    ...
    variables = db.Column(db.String(21000), comment='配置参数1')
    variables_two = db.Column(db.String(21000), comment='配置参数2')
    variables_three = db.Column(db.String(21000), comment='配置参数3')
    variables_four = db.Column(db.String(21000), comment='配置参数4')
