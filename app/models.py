...
class Config(db.Model):
    ...
    variables_two = db.Column(db.String(1024), comment='配置参数2')
    variables_three = db.Column(db.String(1024), comment='配置参数3')
    variables_four = db.Column(db.String(1024), comment='配置参数4')
